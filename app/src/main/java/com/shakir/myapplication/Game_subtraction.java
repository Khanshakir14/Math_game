...
public class Game_subtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = findViewById(R.id.textViewScore_s);
        life = findViewById(R.id.textViewLife_s);
        time = findViewById(R.id.textViewTime_s);

        question = findViewById(R.id.textViewQuestion_s);
        answer = findViewById(R.id.editTextAnswer_s);

        ok = findViewById(R.id.buttonOK_s);
        next = findViewById(R.id.buttonNextQuestion_s);
